...
class CursosTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.cursos_1 = Curso.objects.create(codigo_curso = 'CTT1', descricao = 'Curso de Teste 1', nivel = 'B')
        self.cursos_2 = Curso.objects.create(codigo_curso = 'CTT2', descricao = 'Curso de Teste 2', nivel = 'B')
    ...
    def test_requisicao_put_para_atualizar_curso(self):
        '''Teste para verificar requisiçao PUT para atualizar um curso'''
        data = {
            'codigo_curso': 'CTT1',
